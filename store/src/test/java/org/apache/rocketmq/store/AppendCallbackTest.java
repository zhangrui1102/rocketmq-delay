...
public class AppendCallbackTest {
    ...
    public void init() throws Exception {
        ...
        ServerWrapper serverWrapper = new ServerWrapper(messageStore,messageStoreConfig.getDelayPathDir());
        CommitLog commitLog = new CommitLog(messageStore,serverWrapper);

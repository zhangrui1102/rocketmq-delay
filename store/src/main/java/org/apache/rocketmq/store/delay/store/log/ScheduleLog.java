...
import org.apache.rocketmq.store.delay.store.ScheduleLogValidatorSupport;
import org.apache.rocketmq.store.delay.store.appender.ScheduleSetAppender;
import org.apache.rocketmq.store.delay.store.model.*;
...
public class ScheduleLog implements Log<ScheduleIndex, LogRecord>, Disposable {
    ...
    public AppendLogResult<ScheduleIndex> appendScheduleLog(MessageExt msgExt) throws Exception {
        ...
        long scheduleTime = 0;
        String propertyScheduleTime = msgExt.getProperty(MessageConst.PROPERTY_SCHEDULE_TIME);
        ...
        MessageAccessor.clearProperty(msgExt,MessageConst.PROPERTY_SCHEDULE_TIME);
        MessageAccessor.clearProperty(msgExt,MessageConst.PROPERTY_DELAY_TIME_LEVEL);
        msgExt.putUserProperty(MessageConst.PROPERTY_DELAY_TIME,Long.toString(scheduleTime));
